...
> 一款基于 Vue.js 的动漫信息展示平台，聚焦国漫资源，适配移动端全面屏（灵动岛 + 小白条），已对接后端数据服务。
...
👥 贡献者
Jackychan-200811 (六花花の邪王真眼) - 项目创建者

rin-7777777 (澪) - 前端适配与 UI 调整

quzhiye90-prog (大西?小西!) - 后端连接与数据支持
